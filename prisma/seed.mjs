...
async function seedRolloutSurfaces(siteIds) {
  const NOTIFY_PILOT = [
    ...
    // ADR-0087 — the throughput-gap watchdog's morning nudge, born pilot.
    // Matches migration 20260839_adr0087_throughput_gap_watchdog.
  ...
  const UI_PILOT = [
    ...
    // (ADR-0047 #3). Matches migration 20260838a_adr0085_ipad_dropoff.
    'ipad_dropoff',
