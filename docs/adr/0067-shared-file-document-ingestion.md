...
- Provisioning `~/.dr3-vision-secrets/doc-ingest.env` with `DOC_INGEST_TOKEN_KEY` on any host that runs ingestion. Until then the connect page returns a loud 503 rather than pretending.
