...
### [ ] T-100: Schema migration — bonus tables
...
### [ ] T-101: Processor bonus rules — off-by-one correction
...
### [ ] T-102: OpenTelemetry SDK + auto-instrumentation
...
### [ ] T-109: Prometheus `/metrics` endpoint
