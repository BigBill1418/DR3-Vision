// Type surface for the (JS) Terex throughput-gap watchdog cron daemon's pure schedule helper, so a
 ...
 * calendar day + that day's UTC offset). This daemon fires at 08:30 PT.
 */
