// Type surface for the (JS) AP-baseline-rebuild cron daemon's pure schedule
...
// side-effect-free (the only consumer of these types is the DST-schedule test).
...
/**
 * POST the internal baseline-rebuild route once. Throws on transport error,
