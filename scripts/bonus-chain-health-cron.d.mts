// Type surface for the (JS) bonus signature-chain health cron daemon's pure schedule
...
/**
 * POST the internal chain-health route once. Throws on transport error, redirect (a
