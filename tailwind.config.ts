 ...
 *
 * Per ADR-0008, the brand is GREEN and BLACK — not red, not navy, not gold.
 * These tokens are the source of truth. Do not introduce arbitrary hex values
 * elsewhere in the codebase.
 *
 * mattressrecycling.us is the public face of DR3 and the visual reference.
 */
const config: Config = {
  darkMode: ['class'],
  content: [
