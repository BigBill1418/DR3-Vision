...
4. **`docs/adr/`** — read all ADRs (84 files as of 2026-08-07: 0001–0079 plus 0019.1/0019.2 and a few split/duplicate numbers; see `docs/adr/README.md` for the index). They are short. They lock in technical decisions you should not re-litigate. ADR-0012 in particular bundles seven Sprint-1 clarifications that supplement ADRs 0001/0004/0008/0009; the bonus system spans ADR-0019/0019.1/0019.2/0020/0021/0022/0023/0025 (0025 hardens the ADR-0019.1 escalation tier-4 alert).
