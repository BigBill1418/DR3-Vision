...
4. **`docs/adr/`** — read all ADRs (**91 files as of 2026-08-08**, re-counted: 0001–0086 plus 0019.1/0019.2 and a few split/duplicate numbers; see `docs/adr/README.md` for the index — **0086 was accepted by Bill at the 2026-08-08 walkthrough and is implemented**: capture-time photo upload grants, which ship INERT until the operator provisions `PHOTO_GRANT_SECRET`; its §4 records why the earlier §0.AJ design was unbuildable and its §10 records two places the ADR text disagreed with the live code). **Amendments are sections INSIDE their ADR, not separate files** — 0077 carries Amendments 1, 2 and 3; 0078, 0079, 0083 and 0084 each carry Amendment 1; none of them adds to the file count. (0077/0078/0079's landed 2026-08-07; 0083's — `saves` in the amended-month editor — and 0084's — the void widened from owner-scoped to SITE-scoped on Bill's call — landed 2026-08-08.) **ADR-0083** (saves are paid units, not processed units), **ADR-0084** (same-day physical-count void) and **ADR-0085** (the walk-up drop-off is a label, a count and a photo) landed 2026-08-08 and DO add three files — they are the P3/P4/P5 phases of the #205 floor handoff. The count is `ls docs/adr/*.md | wc -l` minus the README. They are short. They lock in technical decisions you should not re-litigate. ADR-0012 in particular bundles seven Sprint-1 clarifications that supplement ADRs 0001/0004/0008/0009; the bonus system spans ADR-0019/0019.1/0019.2/0020/0021/0022/0023/0025 (0025 hardens the ADR-0019.1 escalation tier-4 alert).
